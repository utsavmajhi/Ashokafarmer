...
public class rejectedrequestAdapter extends RecyclerView.Adapter<rejectedrequestAdapter.MyViewHolder>{

    Context mContext;
    private ArrayList<rejectedrequestitem> mpendingitemlist;


    public rejectedrequestAdapter(Context mContext, ArrayList<rejectedrequestitem> mpendingitemlist) {
